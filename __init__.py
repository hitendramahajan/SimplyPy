...
if __name__ == '__main__':
    PATH = r'e:\IDE\SimplyPy'

    EXCLUDE_FILES = [__file__]

    INTERPRETER_PATH = r'e:\IDE\SimplyPy\venv\Scripts\python.exe'

    VENV_PATH = r'e:\IDE\SimplyPy\venv'

    ENV_TYPE = r'Python venv'

    LOG_FILE = r'c:\Users\Administrator\.vscode\extensions\undefined_publisher.sasva-toolkit-1.0.0\Config\error_log.txt'
